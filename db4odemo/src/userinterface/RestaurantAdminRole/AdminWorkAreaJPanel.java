...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public AdminWorkAreaJPanel(JPanel userProcessContainer,UserAccount userAccount,EcoSystem ecosystem) {
        ...
        for(Restaurant re:ecosystem.getRestaurantDirectory().getRestaurantList()){
            if(re.getUserAccount().getUsername().equals(userAccount.getUsername())){
                restaurant = re;
                valueLabel.setText(re.getName());
            }
        }
    ...
    private void userJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userJButtonActionPerformed
        ...
        JPanel manageRestInfoJPanel  = new ManageRestInfo(userProcessContainer,restaurant,ecosystem);
        userProcessContainer.add(manageRestInfoJPanel);
    ...
    private void manageEmployeeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeeJButtonActionPerformed
        ...
        JPanel manageMenuJPanel  = new ManageMenu(userProcessContainer,restaurant,ecosystem);
    ...
    private void manageOrganizationJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrganizationJButtonActionPerformed
        JPanel manageOrdersJPanel  = new ManageOrders(userProcessContainer,userAccount,ecosystem,restaurant);
        userProcessContainer.add(manageOrdersJPanel);
        CardLayout crdLyt = (CardLayout) userProcessContainer.getLayout();
        crdLyt.next(userProcessContainer);
