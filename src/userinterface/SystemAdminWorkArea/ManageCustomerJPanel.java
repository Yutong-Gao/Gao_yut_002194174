...
public class ManageCustomerJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Age", "Birthday", "Phone Number", "Address"
            }
        ));
    ...
    private void btnAddNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNewActionPerformed
        ...
        Customer customer = ecosystem.getCustomerDirectory().createCustomer(name, phoneNum, address, age, birthday);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        int id =(Integer)model.getValueAt(selectRowIndex, 0);
        ecosystem.getCustomerDirectory().updateCustomer(id, name, phoneNum, address, age, birthday);  
        populateTable();
