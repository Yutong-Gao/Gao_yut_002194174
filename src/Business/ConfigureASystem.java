...
public class ConfigureASystem {
    ...
    public static EcoSystem configure(){
        ...
        //have some employees 
        //create user account
        Customer c1 = system.getCustomerDirectory().createCustomer("c1", 1234123123, "55 station landing ", 20,"2001-07-27");
        Customer c2 = system.getCustomerDirectory().createCustomer("c2", 1234123125, "75 Saint Aphonsus ", 23,"1998-03-23");
